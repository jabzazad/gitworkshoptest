<?php
	...
	$sql = "UPDATE account SET LastUpdate = NOW() WHERE Mid 
	= '".$_SESSION["Mid"]."' ";
	...
	<header class="header-v4">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="images/icons/logo1234.JPG" alt="IMG-LOGO"></a>
			</div>
		...
		<ul id="sidebarnav">
			...
			<li class="active"> <a class="has-arrow  " href="#" aria-expanded="true"><i class="fa fa-tachometer"></i><span class="hide-menu">Member</span></a>
				<ul aria-expanded="true" class="collapse in">
					...
					<li><a href="Reportmember">Purchase History </a></li>
				</ul>
			</li>
		</ul>
	</nav></div>
	<div class="col-6 col-lg-10">
            <div class="card">
                    ...
                    <div class="card-body">
						<?php
$connect = mysqli_connect("localhost", "root", "", "market");
						$query = "SELECT * FROM personalinfo inner join account on personalinfo.username=account.username where Mid=".$_SESSION['Mid'];
						$result = mysqli_query($connect, $query);
						if(!$result){
							echo mysqli_error().'<br>';
							die('Can not acess database');
						...
						while($row = mysqli_fetch_array($result)){
						echo '<h5>Memberid :
							<input type="text" name="" id="" value="'.$row['Mid'].'" disabled>
						</h5><br>
						<h5>Username:	
						<input type="text" name="" id="" value="'.$row['username'].'" disabled></h5><br>
						<h5>E-mail :
						<input type="text" name="" id="" value="'.$row['Email'].'" disabled></h5><br>
						<h5>Name :
						<input type="text" name="" id="" value="'.$row['Firstname'].'  '.$row['Lastname'].'" disabled></h5><br>
						<h5>Phonenumber :
						<input type="text" name="" id="" value="'.$row['Phonenumber'].'" disabled></h5><br>';
						}
					}
						?>
                    </div>
