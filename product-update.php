	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
		<div class="container">
			<div class="row">
               ...
               echo'<input type="text" name="Upname" id="Upname" value= '.$row['Pname'].'>';        
					echo'</h4>
                        <span class="mtext-106 cl2">';
                        echo'<input type="text" name="Upprice" id="Upprice" value= '.$row['Pprice'].'>';  
					echo	'</span>';
                        echo'<textarea name="Updescript" rows="4" cols="50">'.$row['Pdescript'].'</textarea>';  
