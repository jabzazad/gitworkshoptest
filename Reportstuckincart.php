...
<html lang="en">
<head>
	<title>ReportStackItemInUserCart</title>
	<meta charset="UTF-8">
...
<?php
	...
	$query = "SELECT * FROM cart INNER JOIN product on cart.Pid=product.Pid
	INNER JOIN account on cart.Mid=account.Mid
	INNER JOIN personalinfo on account.username=personalinfo.username
	  ORDER BY cart.Dates ASC";
